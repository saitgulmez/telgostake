...
const Home = () => {
  return (
    <div className="w-screen h-screen overflow-auto m-4 ">
      {/* <section className="flex space-x-4 w-screen h-screen bg-black">
        <div className=" card w-96 h-32 p-12 align-items-center text-center">
          <h1>Stake</h1>
        </div>
        ...
        <div>
          ...
          >
            <button
             ...
             font-medium rounded-lg text-md px-5 py-2.5 text-center text-white-900 me-2 mt-10"
            >
              Stake now
            </button>
          </a>
